 ...
 * wire ( 1 bit )- information about the operating mode if 0 we are in read, if
 * 1 we are in writh 2nd wire ( log2 number of blocks ) - addresse of the block
 * we are to read/write 3rd wire ( size of block bits ) - data that is to be
 * writen if we are in withing mode
 * <p>
...
public class DATAModel extends RegisterModel_Abstract {
     ...
     * action
     * <p>
     * This action will eater perform a read or a write on our work data in our
