 ...
 * <p>
 * \details This probe is the exit point for the graph, the data is retrived by
 * the API from this point. This probe holds the end values of our simulation.
 */
public class ProbeEndModel extends ProbeModel_Abstract {
    ...
    /**
     * \fn getData \brief Get the data from the directly connected wire ans
     * store it in this.data
     *
     * @return this.data
     */
    @Override
