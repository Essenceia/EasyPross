...
public class API {
     ...
     */
    /**
     * tion sends the return of the LoadModule function to the HMI
     */
    /**
     * initialization of the communication interface
     */
    /**
     * the identifier of the operation to be performed and the absolute path to
     * the file containing the module are sent over the channel
     */
    /**
     * ************************************************************************************************************************
     */
     ...
     */
    /**
     * tion sends the return of the Simul function to the HMI
     */
    /**
     * initialization of the communication interface
     */
    /**
     * the identifier of the operation to be performed and the success or
     * failure are sent over the channel
     */
    /**
     * ************************************************************************************************************************
     */
     ...
     */
    /**
     * tion sends the return of the GetDataItem function to the HMI
     */
    /**
     * initialization of the communication interface
     */
    /**
     * the identifier of the operation to be performed, the identifier of the
     * wire
     */
    /**
     * and the value of the bits of data running through the wire are sent to
     * the HMI
     */
    /**
     * ************************************************************************************************************************
     ...
     */
    /**
     * tion sends the return of the ChangeDataItem function to the HMI
     */
    /**
     * initialization of the communication interface
     */
     ...
     */
    /**
     * tion sends the return of the Reset function to the HMI
     */
    /**
     * initialization of the communication interface
     */
     ...
     */
    /**
     * ends the return of the GetDataRegister function to the HMI
     */
    /**
     * initialization of the communication interface
     */
    /**
     * the identifier of the operation to be performed and the absolute path to
     * the register file are sent to the HMI
     */
    /**
     * *****************************************************************************************************************
     */
     ...
     */
    /**
     * tion sends the return of the ChangeDataRegister function to the
     * HMI
     */
    /**
     * initialization of the communication interface
    ...
    /**
     * the identifier of the operation to be performed, the identifier of the
     * register and the success or failure are sent to the HMI
     */
    /**
     * ************************************************************************************************************************
     */
     ...
     */
    /**
     * tion gets the data sent from the HMI and sends it to the
     * appropriate function according to the operation identifier
     */
    /**
     * initialization of the communication interface
     */
    /**
     * according to the value of the operation identifier, the corresponding
     * function is called with the right attributes
     */
    /**
     * ************************************************************************************************************************
     */
